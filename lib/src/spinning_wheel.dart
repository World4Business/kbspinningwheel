...
import 'package:kbspinningwheel/src/utils.dart';
  ...
  const SpinningWheel({
    ...
    this.shouldStartOrStop,
        ...
        assert(secondaryImage == null ||
            (secondaryImageHeight != null &&
                secondaryImageWidth != null &&
                (secondaryImageHeight <= height &&
                    secondaryImageWidth <= width)));

   @override
   State<SpinningWheel> createState() { // Avoid using private types in public APIs.
...
class _SpinningWheelState extends State<SpinningWheel>
  ...
  void _updateAnimationValues() {
    ...
    _currentDivider = int.parse("${widget.dividers}") -
